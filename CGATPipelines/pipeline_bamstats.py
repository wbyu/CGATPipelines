...
The following reports are generated as part of running:
    ...
    * Jupyter notebook - a python implimentation
    * Rmarkdown - an R report implimentation
    * multiQC - this builds a basic report from the output of some of the
                external tools that are ran as part of this pipeline. There
                is the potential for customising multiQC so it can be used
